...
export const intentionOptions: { id: Intention; label: string; description: string }[] = [
  { id: "healing", label: "Healing", description: "For calm and relief." },
  { id: "wealth", label: "Prosperity", description: "For money and support." },
  { id: "love", label: "Love", description: "For warmth and repair." },
  { id: "focus", label: "Focus", description: "For study and deep work." },
  { id: "protection", label: "Protection", description: "For travel and change." }
];
...
export const deities: Deity[] = [
  {
    ...
    essence: "Soft mercy for healing and inner quiet.",
    sigil: "Lotus Tide",
    blessing: "May softness reveal a calmer way forward.",
  ...
  },
  {
    ...
    essence: "Steady prosperity for work, money, and courage.",
    sigil: "Prosperity Seal",
    blessing: "May your efforts find steadier ground and real support.",
  ...
  },
  {
    ...
    essence: "Warm connection for love, honesty, and repair.",
    sigil: "Thread Knot",
    blessing: "May the connections you nurture grow warmer and clearer.",
  ...
  },
  {
    ...
    essence: "Clear focus for study, craft, and follow-through.",
    sigil: "Celestial Brush",
    blessing: "May your mind stay steady long enough for clarity to return.",
  ...
  },
  {
    ...
    essence: "Safe passage for travel, change, and steadiness.",
    sigil: "Harbor Compass",
    blessing: "May your path feel guided, steady, and protected.",
